...
class AnchoredScaleBar(AnchoredOffsetbox):
    def __init__(self, transform, sizex=0, sizey=0, labelx=None, labely=None, loc=4,
                 pad=0.1, borderpad=0.1, sep=2, prop=None, textprops=None, barcolor="black", barwidth=None,
                 y_rotation=90,
                 **kwargs):
        """
...
def add_scalebar(ax, matchx=True, matchy=True, hidex=True, hidey=True, labelypad=0, fmt=".2f", **kwargs):
    ...
    kwargs.setdefault("bbox_transform", ax.transAxes)
