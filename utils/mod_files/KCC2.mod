TITLE Simple model of Potassium Chloride Co-transporter 2 (KCC2)
...
KINETIC scheme {
	: this statement need to be in the KINETIC block to be calculated at different points of the section
	flux(cli,clo,ki,ko)
