TITLE simple AMPA+NMDA receptors

: Hines combined AMPA and NMDA and spike dependent plasticity

: Modified from the original AMPA.mod, M.Migliore Jan 2003

: Further modified from Cavarretta et al 2016, 2018 to be more inline with hippocampal/pyramidal
